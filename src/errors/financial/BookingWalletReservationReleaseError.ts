export const BOOKING_WALLET_RELEASE_ERROR_CODES = [
...
export type BookingWalletReleaseErrorCode =
  (typeof BOOKING_WALLET_RELEASE_ERROR_CODES)[number];

export class BookingWalletReservationReleaseError extends Error {
  readonly statusCode: number;

  constructor(
    message: string,
    readonly code: BookingWalletReleaseErrorCode,
