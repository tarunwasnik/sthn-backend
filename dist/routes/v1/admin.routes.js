...
const governanceCompatibility_controller_1 = require("../../controllers/adminActions/governanceCompatibility.controller");
const adminGovernanceRead_controller_1 = require("../../controllers/adminGovernanceRead.controller");
...
router.get("/governance/targets/:userId", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminGovernanceRead_controller_1.getAdminGovernanceTargetController);
...
/* ================= USER MANAGEMENT ================= */
router.patch("/users/:id/suspend", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), governanceCompatibility_controller_1.suspendUserThroughAdminAction);
router.patch("/users/:id/activate", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), governanceCompatibility_controller_1.activateUserThroughAdminAction);
router.patch("/users/:id/ban", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), governanceCompatibility_controller_1.banUserThroughAdminAction);
...
/* ================= TRUST / ABUSE ================= */
router.patch("/users/:id/reset-trust", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), governanceCompatibility_controller_1.resetUserTrustThroughAdminAction);
/* ================= BOOKING OVERRIDES ================= */
...
/* ================= DISPUTE RESOLUTION ================= */
router.get("/disputes", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.listAdminDisputes);
router.patch("/disputes/:disputeId/input-access", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.setAdminDisputeInputAccess);
router.post("/disputes/:disputeId/findings", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.addAdminDisputeFinding);
router.post("/disputes/:disputeId/finalize", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.finalizeAdminDispute);
router.post("/disputes/:disputeId/requests", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.createAdminDisputeRequest);
router.post("/disputes/:disputeId/share", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.shareAdminDisputeSubmission);
router.get("/disputes/:disputeId/investigation", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.getAdminDisputeInvestigation);
router.post("/disputes/:disputeId/evidence/images", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), upload_middleware_1.chatImageUpload.single("file"), disputeDirectEvidence_controller_1.uploadAdminImage);
router.post("/disputes/:disputeId/evidence/documents", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), upload_middleware_1.chatDocumentUpload.single("file"), disputeDirectEvidence_controller_1.uploadAdminDocument);
...
router.get("/disputes/:disputeId", auth_middleware_1.protect, (0, authorize_middleware_1.authorizeRoles)("admin"), adminDispute_controller_1.getAdminDispute);
/* ================= APPEALS ================= */
