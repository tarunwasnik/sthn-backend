...
exports.DisputeInvestigationSubmission = void 0;
...
const SubmissionSchema = new mongoose_1.Schema({
    submissionReference: { type: String, required: true, immutable: true, unique: true, index: true, default: () => `DISPUTE_SUBMISSION_${crypto_1.default.randomBytes(10).toString("hex").toUpperCase()}` },
    disputeId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Dispute", required: true, immutable: true, index: true },
    bookingId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Booking", required: true, immutable: true, index: true },
    submittedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, immutable: true },
    ...
    sharedWithCounterpartyAt: Date, sharedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "User" },
}, { timestamps: true });
SubmissionSchema.index({ disputeId: 1, createdAt: 1, _id: 1 });
exports.DisputeInvestigationSubmission = mongoose_1.default.model("DisputeInvestigationSubmission", SubmissionSchema);
