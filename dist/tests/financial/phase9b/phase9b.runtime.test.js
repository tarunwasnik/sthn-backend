...
const withdrawalProviderInitialization_test_1 = require("./withdrawalProviderInitialization.test");
...
(0, withdrawalProviderInitialization_test_1.registerWithdrawalProviderInitializationTests)();
(0, withdrawalProviderReplay_test_1.registerWithdrawalProviderReplayTests)();
(0, withdrawalProviderConcurrency_test_1.registerWithdrawalProviderConcurrencyTests)();
(0, withdrawalProviderFailure_test_1.registerWithdrawalProviderFailureTests)();
(0, withdrawalProviderRegression_test_1.registerWithdrawalProviderRegressionTests)();
