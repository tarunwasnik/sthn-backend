...
exports.getHighRiskCreatorsService = void 0;
const booking_model_1 = require("../../models/booking.model");
const getHighRiskCreatorsService = async () => {
    const now = new Date();
    const riskyCreators = await booking_model_1.Booking.aggregate([
...
exports.getHighRiskCreatorsService = getHighRiskCreatorsService;
