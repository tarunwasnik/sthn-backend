...
exports.getRiskSummaryService = void 0;
const booking_model_1 = require("../../models/booking.model");
const getRiskSummaryService = async () => {
    const now = new Date();
    const results = await booking_model_1.Booking.aggregate([
...
exports.getRiskSummaryService = getRiskSummaryService;
