...
exports.currencyMetadataService = exports.CurrencyMetadataService = void 0;
...
class CurrencyMetadataService {
    normalize(value) {
        ...
        if (!supportedCurrencies_1.SUPPORTED_CURRENCIES.includes(code) || !metadata[code]?.enabled) {
    ...
    listEnabled() {
        return supportedCurrencies_1.SUPPORTED_CURRENCIES
            .filter((code) => metadata[code].enabled)
            .map((code) => ({ ...metadata[code] }));
    }
}
exports.CurrencyMetadataService = CurrencyMetadataService;
exports.currencyMetadataService = new CurrencyMetadataService();
