...
exports.applyCreatorCooldown = (0, adminAsyncHandler_1.adminAsyncHandler)(async (req, res) => {
    try {
        ...
        const result = await (0, adminActionDispatcher_service_1.executeAdminActionService)({ adminId: req.user.id, adminRole: req.user.role, key: "APPLY_CREATOR_COOLDOWN", targetId, params: params ?? {}, reason, dryRun, confirmationToken });
