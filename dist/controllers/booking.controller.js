...
exports.refundBooking = exports.requestBooking = exports.getUserBookings = void 0;
...
========================================================= */
const cleanupExpiredBookings = async (creatorId, session) => {
...
const requestBooking = async (req, res) => {
    ...
    try {
        ...
        await cleanupExpiredBookings(new mongoose_1.default.Types.ObjectId(creatorId), session);
        const slots = await slot_model_1.Slot.find({
            _id: { $in: slotIds },
            status: "AVAILABLE",
